...
export default function Techniques() {
  ...
  const techniques: Technique[] = [
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/1470853/pexels-photo-1470853.jpeg?auto=compress&cs=tinysrgb&w=800",
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#8A7A6A] max-w-2xl mx-auto">
            Conoce los detalles de cada técnica y elige la que mejor se adapte a
            tu estilo de vida
          </p>
        </div>
        ...
        <div className="space-y-4">
          {techniques.map((technique, index) => (
            ...
            >
              ...
              >
                <h3 className="text-2xl font-medium text-[#5A4A3A]">
                  {technique.title}
                </h3>
                {openIndex === index ? (
                ...
                <div className="px-8 pb-8 animate-fade-in">
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <h4 className="text-lg font-medium text-[#5A4A3A] mb-3">
                        Beneficios:
                      </h4>
